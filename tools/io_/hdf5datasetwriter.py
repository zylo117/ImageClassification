...
class HDF5DatasetWriter:
    def __init__(self, dims, outputPath, dataKey="images", bufSize=128, overwrite=False, compression=0):
        ...
        self.data = self.db.create_dataset(dataKey, dims, dtype=np.float, compression=compression)
        self.labels = self.db.create_dataset("labels", (dims[0],), dtype=np.int, compression=compression)
